...
//        }
        [sharedInstance.logCategories addObject:[LogCategory carMockLog]];
        [sharedInstance.logCategories addObject:[LogCategory fitnessMockLog]];
        [sharedInstance.logCategories addObject:[LogCategory runningMockLog]];
    });
